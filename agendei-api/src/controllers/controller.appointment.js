...
async function Listar(req,res){
    ...
    const appointments = await serviceAppointment.ListarByUser(0,dt_start,dt_end,id_doctor);
...
async function ListarbyId(req,res){
    ...
    const appointments = await serviceAppointment.ListarbyId(id_appointment);
...
async function InserirAdmin(req,res){
    ...
    const appointment = await serviceAppointment.InserirAdmin(id_user,id_doctor,id_service,
                                                            booking_date,booking_hour);
...
async function EditarAdmin(req,res){
    ...
    const appointment = await serviceAppointment.EditarAdmin(id_appointment,id_user,id_doctor,id_service,
                                                            booking_date,booking_hour);
...
export default {ListarByUser,Inserir,Excluir,Listar,ListarbyId,InserirAdmin,EditarAdmin}